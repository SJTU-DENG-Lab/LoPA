...
tasks="mbpp mbpp mbpp gsm8k gsm8k gsm8k"
nshots="3 3 3 4 4 4"
lengths="512 512 512 512 512 512"
temperatures="0 0 0 0 0 0"
limits="10000 10000 10000 10000 10000 10000"
block_sizes="32 32 32 32 32 32"
block_add_thresholds="0.3 0.3 0.3 0.1 0.1 0.1"
decoded_token_thresholds="0.95 0.95 0.95 0.95 0.95 0.95"
skip_thresholds="0.95 0.95 0.95 0.95 0.95 0.95"
top_ps="none none none none none none"
dtypes="bfloat16 bfloat16 bfloat16 bfloat16 bfloat16 bfloat16"
sampling_strategies="neg_entropy neg_entropy neg_entropy neg_entropy neg_entropy neg_entropy"
max_branches_kepts="1 1 1 1 1 1"
branching_factors="2 4 8 2 4 8"
branch_topps="1 1 1 1 1 1"
selection_conf_alphas="0 0 0 0 0 0"
branch_verification_modes="true true true true true true"
base_branch_competitions="true true true true true true"
...
limits="10000"
block_sizes="32"
block_add_thresholds="0.3"
decoded_token_thresholds="0.95"
skip_thresholds="0.95"
top_ps="none"
dtypes="bfloat16"
...
# 关键修改：分支因子设置为 2, 4, 8
humaneval_branching_factors="2 4 8"
...
for lora_model in "${lora_models[@]}"; do
    ...
    for i in "${!HUMANEVAL_NSHOTS_ARRAY[@]}"; do
        ...
        HF_ENDPOINT=https://hf-mirror.com CUDA_VISIBLE_DEVICES=0,1,2,3,4,5,6,7 accelerate launch --main_process_port 29520 --num_processes 8 eval_dream_xck_true_analyse2.py --model dream_lora_spec \
    ...
    for i in "${!TASKS_ARRAY[@]}"; do
        ...
        HF_ENDPOINT=https://hf-mirror.com CUDA_VISIBLE_DEVICES=0,1,2,3,4,5,6,7 accelerate launch --main_process_port 29520 --num_processes 8 eval_dream_xck_true_jointlog_analyse_basebranch.py --model dream_lora_spec \
