...
# OUTPUT_PATH="./eval_results_dream/${TASK}_length256_steps256_prompt-1_gen-1"
...
# OUTPUT_PATH="./eval_results_dream/${TASK}_length256_steps256_prompt100_gen8"
# accelerate launch --config_file ${ACCEL_CONFIG} --main_process_port ${MAIN_PORT} evaluation_script.py --model dream \
...
# OUTPUT_PATH="./eval_results_dream/${TASK}_length256_steps256_prompt5_gen1"
# accelerate launch --config_file ${ACCEL_CONFIG} --main_process_port ${MAIN_PORT} evaluation_script.py --model dream \
...
# OUTPUT_PATH="./eval_results_dream/${TASK}_length256_steps256_prompt25_gen8"

# accelerate launch --config_file ${ACCEL_CONFIG} --main_process_port ${MAIN_PORT} evaluation_script.py --model dream \
#     --model_args pretrained=${model},max_new_tokens=${MAX_NEW_TOKENS},diffusion_steps=${DIFFUSION_STEPS},temperature=${TEMPERATURE},top_p=${TOP_P},add_bos_token=${ADD_BOS_TOKEN},alg="entropy",alg_temp=0.0,prompt_interval_steps=25,gen_interval_steps=8,cfg_interval_steps=1,transfer_ratio=0.25,is_feature_cache=True,is_cfg_cache=False,save_dir=${OUTPUT_PATH} \
#     --tasks ${TASK} \
#     --num_fewshot ${NUM_FEWSHOT} \
#     --batch_size 1 \
#     --output_path ${OUTPUT_PATH} \
...
# OUTPUT_PATH="./eval_results_dream/${TASK}_length256_steps256_prompt100_gen4"
# accelerate launch --config_file ${ACCEL_CONFIG} --main_process_port ${MAIN_PORT} evaluation_script.py --model dream \
