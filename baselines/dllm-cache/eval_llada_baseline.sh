...
--model_args "pretrained=/mnt/rl/xinyi/models/LLaDA-8B-Instruct,prompt_interval_steps=-1,gen_interval_steps=-1,transfer_ratio=0,cache_order=0,is_feature_cache=False,is_cfg_cache=False,save_dir=./eval_results_llada/gsm8k_log_block8_len256_steps256_prompt-1_gen-1" \
...
--model_args "pretrained=/mnt/rl/xinyi/models/LLaDA-8B-Instruct,prompt_interval_steps=-1,gen_interval_steps=-1,transfer_ratio=0,cache_order=0,is_feature_cache=False,is_cfg_cache=False,save_dir=./eval_results_llada/humaneval_log_block32_len512_steps512_prompt-1_gen-1" \
...
--model_args "pretrained=/mnt/rl/xinyi/models/LLaDA-8B-Instruct,prompt_interval_steps=-1,gen_interval_steps=-1,cache_order=0,transfer_ratio=0,is_feature_cache=False,is_cfg_cache=False,save_dir=./eval_results_llada/mbpp_log_block32_len512_steps512_prompt-1_gen-1" \
...
--model_args "pretrained=/mnt/rl/xinyi/models/LLaDA-8B-Instruct,prompt_interval_steps=-1,gen_interval_steps=-1,cfg_interval_steps=-1,transfer_ratio=0,is_feature_cache=False,is_cfg_cache=False,save_dir=./eval_results_llada/minerva_math_log_block256_len256_steps256_prompt-1_gen-1" \
