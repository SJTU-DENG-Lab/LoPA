...
OUTPUT_ROOT="./eval_results_dream_instruct_t01p09"
mkdir -p "${OUTPUT_ROOT}"
...
# TEMPERATURE=0.1    # From tasks="gsm8k_cot ...", temperatures="0 ..."
# TOP_P=0.9        # Constant in the original loop's model_args
...
# NUM_FEWSHOT=0
# MAX_NEW_TOKENS=512
# DIFFUSION_STEPS=512 # Note: based on original script
# TEMPERATURE=0.1
# TOP_P=0.9
# ADD_BOS_TOKEN="true"
...
# DIFFUSION_STEPS=256 # Note: based on original script (equal to max_new_tokens)
# TEMPERATURE=0.1    # From tasks="... mbpp ...", temperatures="... 0.1 ..."
# TOP_P=0.9        # Constant in the original loop's model_args
# ADD_BOS_TOKEN="true" # Constant in the original loop's model_args
# # Note: original loop did NOT include escape_until=true
...
DIFFUSION_STEPS=256 # Note: based on original script (equal to max_new_tokens)
TEMPERATURE=0.1    # From tasks="... minerva_math ...", temperatures="... 0 ..."
TOP_P=0.9        # Constant in the original loop's model_args
ADD_BOS_TOKEN="true" # Constant in the original loop's model_args
# Note: original loop did NOT include escape_until=true
