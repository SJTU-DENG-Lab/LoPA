...
# 多个LoRA模型路径，用空格分隔
lora_models=(
    "/home/chenkai/data/ckpt/wx_llada_new/Decoder-ddt_test-25k"
...
# 获取LoRA模型的基本名称用于输出目录
    ...
    for i in "${!HUMANEVAL_NSHOTS_ARRAY[@]}"; do
        ...
        # CUDA_VISIBLE_DEVICES=0,1,2,3,4,5,6,7 accelerate launch --main_process_port 29520 --num_processes 8 eval_llada_xck_true.py --model dream_lora \
